...
package uk.gov.hmrc.disaaccountstubs.models.journeyData

import play.api.libs.json.{Format, Json, Reads, Writes}
import uk.gov.hmrc.disaaccountstubs.models.journeyData.certificatesofauthority.CertificatesOfAuthority
import uk.gov.hmrc.disaaccountstubs.models.journeyData.isaProducts.IsaProducts
import uk.gov.hmrc.disaaccountstubs.models.journeyData.liaisonofficers.LiaisonOfficers
import uk.gov.hmrc.disaaccountstubs.models.journeyData.orgdetails.OrganisationDetails
import uk.gov.hmrc.disaaccountstubs.models.journeyData.signatories.Signatories
import uk.gov.hmrc.disaaccountstubs.models.journeyData.thirdparty.ThirdPartyOrganisations
