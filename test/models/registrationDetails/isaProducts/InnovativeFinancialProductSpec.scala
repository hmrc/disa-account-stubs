...
import uk.gov.hmrc.disaaccountstubs.models.registrationDetails.isaProducts.InnovativeFinancialProduct

class InnovativeFinancialProductSpec extends AnyWordSpec with Matchers {
