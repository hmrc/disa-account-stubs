...
import uk.gov.hmrc.disaaccountstubs.models.registrationDetails.certificatesofauthority.FcaArticles

class FcaArticlesSpec extends AnyWordSpec with Matchers {
